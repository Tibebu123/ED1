...
import residence1 from "../../assets/images/three4.jpg";
import residence2 from "../../assets/images/three2.jpg";
import residence3 from "../../assets/images/three6.jpg";
import residence4 from "../../assets/images/three4.jpg";
import residence5 from "../../assets/images/threed.jpg";
import residence6 from "../../assets/images/three2.jpg";
      ...
      >
        ...
        <div className="container mx-auto px-4 h-full flex flex-col">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start flex-grow">
            ...
            <div className="flex flex-col gap-8 h-full lg:col-span-1"> {/* Added lg:col-span-1 to ensure proper width */}
              <motion.div
                initial={{ opacity: 0, x: 50 }}
                animate={{ opacity: 1, x: 0 }}
