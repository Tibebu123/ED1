...
import residence1 from "../../assets/images/single.jpg";
import residence2 from "../../assets/images/single1.jpg";

export function Singlepage2() {
  return (
      ...
      >
        ...
        <div className="container mx-auto px-4 h-full flex flex-col">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            >
              <div className="relative h-[450px] w-full group"> {/* Reduced from 600px */}
                <img
                  src={residence1}
          ...
          <motion.div
            ...
            className="mt-auto pt-12 text-center"> {/* Reduced padding-top */}
