...
import residence1 from "../../assets/images/resdence2.jpg";
import residence2 from "../../assets/images/resdence1.jpg";
import residence3 from "../../assets/images/resdence4.jpg";
import residence4 from "../../assets/images/resdence3.jpg";
import residence5 from "../../assets/images/resdence5.png";
import residence6 from "../../assets/images/eden5.jpg";
        ...
        <div className="container mx-auto px-4 h-full flex flex-col">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start flex-grow">
            ...
            >
              ...
              {/* Bottom left image */}
              <motion.div
                className="relative h-96 w-full group bg-black mt-auto"
                whileHover={{ scale: 1.02 }}
                transition={{ duration: 0.3 }}
              >
                <img
            ...
            {/* Right Column - Three images with title */}
            <motion.div
              initial={{ opacity: 0, x: 50 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            >
              ...
              >
                <h1 className="text-5xl md:text-6xl font-bold tracking-tight bg-gradient-to-r from-blue-400 to-white bg-clip-text text-transparent mb-4">
                  3D VIEW
                </h1>
              </motion.div>
